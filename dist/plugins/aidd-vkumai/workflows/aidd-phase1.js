...
const sweepAgents = [
  () => agent(sweepPrompt, { label: 'sweep-ui',    agentType: 'aidd-vkumai:sweep-ui',    phase: 'Sweep', schema: AGENT_RESULT_SCHEMA, effort: 'low' }),
  () => agent(sweepPrompt, { label: 'sweep-data',  agentType: 'aidd-vkumai:sweep-data',  phase: 'Sweep', schema: AGENT_RESULT_SCHEMA, effort: 'low' }),
  () => agent(sweepPrompt, { label: 'sweep-db',    agentType: 'aidd-vkumai:sweep-db',    phase: 'Sweep', schema: AGENT_RESULT_SCHEMA, effort: 'low' }),
  () => agent(sweepPrompt, { label: 'sweep-types', agentType: 'aidd-vkumai:sweep-types', phase: 'Sweep', schema: AGENT_RESULT_SCHEMA, effort: 'low' }),
]
