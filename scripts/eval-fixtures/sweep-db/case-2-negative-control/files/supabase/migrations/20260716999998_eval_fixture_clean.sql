CREATE TABLE IF NOT EXISTS eval_fixture_clean_items (
...
CREATE OR REPLACE FUNCTION get_eval_fixture_clean_items(p_facility_id UUID)
...
BEGIN
  ...
  RETURN QUERY
    ...
    FROM eval_fixture_clean_items i
    WHERE i.facility_id = p_facility_id;
END;
$$;

-- 未認証には渡さない
GRANT EXECUTE ON FUNCTION get_eval_fixture_clean_items TO authenticated;
