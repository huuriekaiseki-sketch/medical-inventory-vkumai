...
run_digest() {
  ...
  OUT="$(FAULT_INJECTION_DRILL_DOC="$WORK/fi.md" HOOK_LIVE_DRILL_DOC="$WORK/hl.md" UPSTREAM_DOCS_REVIEW_DOC="$WORK/ud.md" \
    MUTATION_TESTING_DOC="$WORK/mt.md" RLS_MUTATION_DOC="$WORK/rm.md" \
...
write_doc "$WORK/mt.md" "$(iso_offset 90)"
...
PLAIN="$(FAULT_INJECTION_DRILL_DOC="$WORK/fi.md" HOOK_LIVE_DRILL_DOC="$WORK/hl.md" UPSTREAM_DOCS_REVIEW_DOC="$WORK/ud.md" MUTATION_TESTING_DOC="$WORK/mt.md" RLS_MUTATION_DOC="$WORK/rm.md" MAINTENANCE_DIGEST_PLAIN=1 bash "$SCRIPT" < /dev/null)"
