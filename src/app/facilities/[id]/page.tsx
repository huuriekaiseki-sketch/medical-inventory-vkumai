...
export default function FacilityDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      <div className="mb-6">
        <Link href="/facilities" className="text-sm hover:underline" style={{ color: '#4B5563' }}>
          ← 施設一覧に戻る
        </Link>
      </div>
        ...
        <table className="min-w-full">
          <tbody>
            <tr style={{ borderBottom: '1px solid #E5E7EB' }}>
              <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-widest w-40" style={{ color: '#4B5563', fontFamily: 'var(--font-oswald), sans-serif', backgroundColor: '#F9FAFB' }}>
                施設名
              </th>
